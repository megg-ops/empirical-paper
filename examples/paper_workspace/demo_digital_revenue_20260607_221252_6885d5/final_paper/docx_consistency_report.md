...
| 2.833 | descriptive.financing_constraint.mean | 融资约束程度均值 |
| 0.132 | main.digital_score.coef | 数字化能力指数回归系数（模型3） |
| 0.035 | main.digital_score.se | 数字化能力指数标准误（模型3） |
| 0.337 | main.r2 | 模型3 R² |
...
| 数字 | 上下文 |
|---|---|
| 0.01 | 注：括号内为HC1稳健标准误。* p<0.1, ** p<0.05, *** p<0.01。行业以制造业为基准组，区域以东部为基准组。 |
