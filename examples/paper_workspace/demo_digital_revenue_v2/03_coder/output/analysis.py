...
# 路径
WORKSPACE = Path("examples/paper_workspace/demo_digital_revenue_v2")
DATA_FILE = Path("examples/demo_case/data.xlsx")
...
corr_vars = ['revenue_growth_pct', 'digital_score', 'firm_age_years', 'employees',
             'rd_intensity_pct', 'marketing_intensity_pct']
    ...
    "figures": [
        {
            ...
            "path": "figures/fig_01_scatter.png",
            "required": True
        },
        {
            "id": "fig_02",
            "title": "各行业平均数字化能力与营业收入增长率",
            "path": "figures/fig_02_industry_comparison.png",
            "required": True
        },
        {
            "id": "fig_03",
            "title": "各区域平均数字化能力与营业收入增长率",
            "path": "figures/fig_03_region_comparison.png",
            "required": True
        },
    ],
    "tables": [
        {
            "id": "table_01",
            "title": "变量描述性统计",
            "path": "tables/tab_01_desc_stats.md",
            "required": True,
        ...
        },
        {
            "id": "table_02",
            "title": "相关系数矩阵",
            "path": "tables/tab_02_correlation.md",
            "required": True,
            "preferred_display": "markdown_table"
        },
        {
            "id": "table_03",
            "title": "基准回归结果",
            "path": "tables/tab_03_baseline.md",
            "required": True,
            "preferred_display": "markdown_table"
        },
        {
            "id": "table_04",
            "title": "异质性分析结果",
            "path": "tables/tab_04_heterogeneity.md",
            "required": True,
            "preferred_display": "markdown_table"
        },
        {
            "id": "table_05",
            "title": "稳健性检验结果",
            "path": "tables/tab_05_robustness.md",
            "required": True,
            "preferred_display": "markdown_table"
        },
    ]
